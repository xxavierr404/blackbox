...
{
    [Space(20)] [Header("Mouse Look Settings :")]
    public Vector2
        clampInDegrees = new(360, 180);
    ...
    [Space(20)] [Header("Camera Move Settings :")]
    ...
    private void FixedUpdate()
    {
        ...
        else if (Input.GetKey(leftKey)) speedX -= acceleration * Time.deltaTime;
        if (Input.GetKey(backKey))
            speedZ -= acceleration * Time.deltaTime;
        else if (Input.GetKey(fwdKey)) speedZ += acceleration * Time.deltaTime;
